...
!
      ...
      public :: qvlofz, lmxofz, cnfig, symbol, atmass, atnumber
...
C Written by J. Soler
      ...
      FUNCTION atnumber( symbol ) result(z)

!! ** This function should not be called from within an I/O statement

C Given the atomic symbol, returns the atomic number
      ...
      do i = 1, nz
         if (name(i) == symbol) then
            z = i
            return
         endif
      enddo
      call die("Wrong symbol")
      end function atnumber
