...
\definecolor{fdf-list}  {cmyk}{0.05,0.05,0.05,0.90}
\definecolor{fdf-option}{cmyk}{0.05,0.05,0.05,1.00}
...
\def\preparelink#1{%
  \expandafter\ifx\csname siesta@hlink@#1\endcsname\relax%
    ...
    \expandafter\xdef\csname siesta@hlink@#1\endcsname{siesta-pos-\the\siestatargetcount}%
  \fi%
}
...
{ %
    ...
    \strut{\bgroup\color{fdf-list}%
        ...
        \expandafter\cleanedhypertarget\expandafter{\@tmp}{\expandafter\fontfdf\expandafter{\@tmp}}%
        \sindex[sfdf]{#1}%
        \egroup%
...
{%
    \begin{fdfentry}{#1}[logical]<.true.|.false.>%
}
{%
  \end{fdfentry}
}
...
{%
    \begin{fdfentry}{#1}[logical]<.false.|.true.>%
}
{%
  \end{fdfentry}
}
