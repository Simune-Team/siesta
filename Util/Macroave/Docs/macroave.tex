...
\noindent
 ...
 provided with the code. This Makefile is able to generate the
 executable file in several architectures by including
 information from the file {\tt arch.make} in the
 main Siesta {\tt Src} directory, which you should have generated in
 advance. It is extremely important that you use the same {\tt
 arch.make} file that you used for Siesta.

 You just need to run the `make' utility
