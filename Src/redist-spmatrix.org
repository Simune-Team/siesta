...
Note about the use of integer group handles. Their value (say, "group = 10") might
...
#+BEGIN_SRC f90 :noweb-ref routine-redist-spmatrix
  subroutine redistribute_spmatrix(norbs,m1,dist1,m2,dist2,mpi_comm)
    ...
    c1 = communicator(dist1)
    c2 = communicator(dist2)
    ...
    call MPI_Group_Incl(gg,nprocs(dist1),ranks(dist1),g1,ierr)
    call MPI_Group_Incl(gg,nprocs(dist2),ranks(dist2),g2,ierr)
