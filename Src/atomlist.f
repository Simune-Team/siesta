...
! Find rco and rckb .............................
     ...
     $     na_u, no_u, nokb_u
      ...
      call de_alloc( iaorb, 'iaorb', 'atomlist' )
      call de_alloc( indxuo, 'indxuo', 'atomlist' )
      call de_alloc( iphorb, 'iphorb', 'atomlist' )
      call de_alloc( Datm, 'Datm', 'atomlist' )
      call de_alloc( rco, 'rco', 'atomlist' )
      call de_alloc( iaKB, 'iaKB', 'atomlist' )
      call de_alloc( iphKB, 'iphKB', 'atomlist' )
      call de_alloc( rckb, 'rckb', 'atomlist' )
