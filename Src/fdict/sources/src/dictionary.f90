...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_s0
function dict_kvp_s0(key, val) result(this)
character(len=*), intent(in) :: key
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_s1
function dict_kvp_s1(key, val) result(this)
character(len=*), intent(in) :: key
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_s2
function dict_kvp_s2(key, val) result(this)
character(len=*), intent(in) :: key
real(sp), intent(in), dimension(:,:), target :: val
type(dict) :: this
this = new_d_key(key)
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_d0
function dict_kvp_d0(key, val) result(this)
character(len=*), intent(in) :: key
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_d1
function dict_kvp_d1(key, val) result(this)
character(len=*), intent(in) :: key
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_d2
function dict_kvp_d2(key, val) result(this)
character(len=*), intent(in) :: key
real(dp), intent(in), dimension(:,:), target :: val
type(dict) :: this
this = new_d_key(key)
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_c0
function dict_kvp_c0(key, val) result(this)
character(len=*), intent(in) :: key
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_c1
function dict_kvp_c1(key, val) result(this)
character(len=*), intent(in) :: key
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_c2
function dict_kvp_c2(key, val) result(this)
character(len=*), intent(in) :: key
complex(sp), intent(in), dimension(:,:), target :: val
type(dict) :: this
this = new_d_key(key)
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_z0
function dict_kvp_z0(key, val) result(this)
character(len=*), intent(in) :: key
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_z1
function dict_kvp_z1(key, val) result(this)
character(len=*), intent(in) :: key
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_z2
function dict_kvp_z2(key, val) result(this)
character(len=*), intent(in) :: key
complex(dp), intent(in), dimension(:,:), target :: val
type(dict) :: this
this = new_d_key(key)
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_b0
function dict_kvp_b0(key, val) result(this)
character(len=*), intent(in) :: key
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_b1
function dict_kvp_b1(key, val) result(this)
character(len=*), intent(in) :: key
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_b2
function dict_kvp_b2(key, val) result(this)
character(len=*), intent(in) :: key
logical, intent(in), dimension(:,:), target :: val
type(dict) :: this
this = new_d_key(key)
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_h0
function dict_kvp_h0(key, val) result(this)
character(len=*), intent(in) :: key
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_h1
function dict_kvp_h1(key, val) result(this)
character(len=*), intent(in) :: key
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_h2
function dict_kvp_h2(key, val) result(this)
character(len=*), intent(in) :: key
integer(ih), intent(in), dimension(:,:), target :: val
type(dict) :: this
this = new_d_key(key)
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_i0
function dict_kvp_i0(key, val) result(this)
character(len=*), intent(in) :: key
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_i1
function dict_kvp_i1(key, val) result(this)
character(len=*), intent(in) :: key
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_i2
function dict_kvp_i2(key, val) result(this)
character(len=*), intent(in) :: key
integer(is), intent(in), dimension(:,:), target :: val
type(dict) :: this
this = new_d_key(key)
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_l0
function dict_kvp_l0(key, val) result(this)
character(len=*), intent(in) :: key
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_l1
function dict_kvp_l1(key, val) result(this)
character(len=*), intent(in) :: key
...
this = new_d_key(key)
call assign(this%first%value,val)
end function dict_kv_l2
function dict_kvp_l2(key, val) result(this)
character(len=*), intent(in) :: key
integer(il), intent(in), dimension(:,:), target :: val
type(dict) :: this
this = new_d_key(key)
