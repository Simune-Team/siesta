...
C Correct velocities to reach target termperature
      if (kin .eq. 0.0) then
        rfac2 = 1.0 + dt/taurelax
      else
        rfac2 = (1.0 + dt/taurelax * (tekin/kin -1.0))
      endif
...
C .....................
      ...
      subroutine verlet1(istep,iunit,iquench,natoms,fa,dt,ma,va,xa,
     .                   kin,temp)
C *************************************************************************
...
C .....................
      ...
      subroutine verlet2(istep,iunit,iquench,natoms,fa,dt,ma,va,xa,
     .                   kin,temp)
C *************************************************************************
...
C nmax = maximum number of atoms
     ...
     .  i,ia
      ...
      double precision
     .  accold(3,nmax),Ang,
     .  dot,dt2,dtby2,eV,fovermp,temp,twodt,
     .  vold(3,nmax)
