...
module class_lSpArr2D
  use class_lArray2D
!========================
#define TYPE_NAME  lSpArr2D
#define STR_TYPE_NAME "lSpArr2D"
#define TYPE_NAME_ lSpArr2D_
#define NEW_TYPE newlSpArr2D
#define VAR_TYPE lArray2D
#define VAR_NEW_TYPE newlArray2D
