...
!C integer nh           : First dimension of listV and H, and maxim.
!C                           number of nonzero elements in any row of H
!C integer numh(nuo)      : Number of non-zero elements in a row of H
!C integer listhptr(nuo)  : Pointer to the start of rows in listh
!C integer listh(nh)   : List of non-zero elements of H
!C ******************** INPUT AND OUTPUT *******************************
!C real*8  H(nh,nspin) : Value of nonzero elements in each row 
!C                           of H to which the potential matrix 
