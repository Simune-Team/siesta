...
! Used MPI procedures and types
  ...
  integer, parameter:: nfTot = 10        ! Number of functionals tested
  integer, parameter:: jf1 = 3           ! First functional tested
  integer, parameter:: jf2 = 3           ! Last functional tested
  integer, parameter:: nRan =  6         ! Number of random points for test
  real(dp),parameter:: latConst = 10._dp ! Lattice constant, in Bohr
  real(dp),parameter:: Ecut = 20._dp     ! Planewave cutoff of the mesh
  ...
  integer :: i, i1, i2, i3, ic, iDelta, ip, iRan, iSpin, lb1, lb2, lb3, &
             ...
             nf, nMesh(3), nNodes, np, ub1, ub2, ub3
  ...
  if (myNode==0) then
    print'(a,2f12.6)', 'Ex, Ec =', Ex, Ec
    print'(a,2f12.6)', 'Dx, Dc =', Dx, Dc
  end if
