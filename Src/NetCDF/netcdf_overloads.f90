...
!
! NOTE: Some (old) versions of Compaq's compiler cannot process the 
! code for "text" put and get routines. All mentions to them here are
! commented out. See README and *.orig files.
!
