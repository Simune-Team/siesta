BIT=64
SIESTA_ARCH=XLF $(BIT)bits PARALLEL MPI+OpenMP
#
FC= mpif90   #xlf90_r
CC= mpicc
#
...
FFLAGS=-O3 -qstrict -qtune=ppc970 -qarch=ppc970 -q$(BIT)  -qsmp=omp -qmaxmem=-1
CFLAGS=-O3 -qtune=ppc970 -qarch=ppc970 -q$(BIT) -qsmp=omp -qmaxmem=-1
...
PARMETIS=$(HOME)/ParMetis-3.1.1/libparmetis.a \
         $(HOME)/ParMetis-3.1.1/libmetis.a

SLU_HOME=$(HOME)/SuperLU_DIST_2.3/
...
LIBS= $(SLU) $(PARMETIS) $(METIS) $(BLAS) $(MPITRACER) $(PAPI) \
      $(OMP_LIB) -L/opt/osshpc/mx/lib$(BIT)/

DEFS= $(DEFS_MPI) $(DEFS_CDF) $(DEFS_TRACE) $(OMP_DEF) -WF,-DDEBUG -WF,-DXLF
